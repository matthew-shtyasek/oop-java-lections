...
public class InternetShop {
    ...
    public static class User {
        ...
        public String showProduct(String name) {
            return String.format("Описание товара %s", name);
        }
    }
    ...
    public static class Client extends User {
        ...
        public String buy(String name) {
            return String.format("Товар %s куплен", name);
        }
    }
    ...
    public static class Manager extends User {
        ...
        public String createProduct(String name) {
            return String.format("Новый товар %s успешно создан", name);
        }

        public String updateProduct(String name) {
            return String.format("Товар %s успешно обновлён", name);
        }

        public String deleteProduct(String name) {
            return String.format("Товар %s успешно удалён", name);
        }
    }
    ...
    public static class SuperManager extends Manager {
        ...
        public String setDiscount(int value, Client client) {
            return String.format("Клиенту %s начислена скидка в размере %d%%", client.getLogin(), value);
        }
    }
    ...
    public static class Admin extends User {
        ...
        public String deleteUser(String name) {
            return String.format("Пользователь %s успешно удалён", name);
        }
    }
}
