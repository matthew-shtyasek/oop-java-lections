...
public class Validator {
    ...
    static void checkPassword(String password) throws LengthException, RegisterException, DigitException {
        ...
        if (password.toLowerCase().equals(password) || password.toUpperCase().equals(password)) throw new RegisterException();
        if (password.replace("[*0-9]", "").equals(password)) throw new DigitException();
    }
